...
public class ParseCommand {
    ...
    public final List<String> movingCommand = new ArrayList<>(Arrays.asList("go", "moving", "move", "walk", "run", "turn"));
    ...
    public final List<String> direction = new ArrayList<>(Arrays.asList("south", "north", "east", "west"));
    final List<String> musicControl = new ArrayList<>(Arrays.asList("play", "stop", "reset", "lower", "raise"));

    public final List<List> listCommand = new ArrayList<>(Arrays.asList(getCommand, checkCommand,
    ...
    public String verifyAction(String commandParse) {
